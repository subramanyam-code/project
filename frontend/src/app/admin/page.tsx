    ...
    <ProtectedLayout>
      <div className="space-y-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Manage your organization</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/admin/companies">
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <CardBody className="text-center py-8">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white">Companies</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Manage companies</p>
              </CardBody>
            </Card>
          </Link>
          ...
          <Link href="/admin/departments">
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <CardBody className="text-center py-8">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Organize departments</p>
              </CardBody>
            </Card>
          </Link>
          ...
          <Link href="/admin/teams">
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <CardBody className="text-center py-8">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Manage teams</p>
              </CardBody>
            </Card>
          </Link>
          ...
          <Link href="/admin/users">
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <CardBody className="text-center py-8">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Manage users & roles</p>
              </CardBody>
            </Card>
          </Link>
          ...
          <Link href="/admin/roles">
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <CardBody className="text-center py-8">
                <div className="w-12 h-12 bg-red-100 dark:bg-red-900/30 rounded-lg flex items-center justify-center text-red-600 dark:text-red-400 mx-auto mb-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h3 className="font-semibold text-gray-900 dark:text-white">Roles</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Configure roles</p>
              </CardBody>
            </Card>
          </Link>
          ...
          <Link href="/admin/audit-logs">
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <CardBody className="text-center py-8">
                <div className="w-12 h-12 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg flex items-center justify-center text-indigo-600 dark:text-indigo-400 mx-auto mb-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <h3 className="font-semibold text-gray-900 dark:text-white">Audit Logs</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">View activity logs</p>
              </CardBody>
            </Card>
          </Link>
        </div>
